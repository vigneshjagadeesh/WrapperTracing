function [weights,w_dist] = vrl_edgeweight(edges,vals,lattice_size,sigma,k,scaling, eVals)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if d == 1,
    e_feat = abs(eVals(edges(:,1))-eVals(edges(:,2))).^k;
else
    e_feat = sum(abs(eVals(:,edges(:,1))-eVals(:,edges(:,2))).^k);
end
%w_feat = abs(w_feat-e_feat);
w_feat(e_feat>5)=0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
